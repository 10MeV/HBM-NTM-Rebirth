...
public class RBMKOutgasserMenu extends AbstractContainerMenu {
    ...
    public RBMKOutgasserMenu(int containerId, Inventory inventory, RBMKColumnBlockEntity blockEntity) {
        ...
        addSlot(HbmInventoryMenuHelper.legacyMachineSlot(blockEntity.outgasserItems(), 0, 48, 45));
        addSlot(HbmInventoryMenuHelper.craftingOutputSlot(inventory.player, blockEntity.outgasserItems(), 1, 112, 69));
