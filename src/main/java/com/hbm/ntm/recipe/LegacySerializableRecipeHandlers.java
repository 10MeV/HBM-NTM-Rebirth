...
public final class LegacySerializableRecipeHandlers {
    ...
    private static final List<Handler> HANDLERS = List.of(
            ...
            modern("MixerRecipes", "hbmMixer.json", Category.FLUID, "mixer",
                    "modern hbm_ntm_rebirth:mixer serializer exists for datapack recipes; legacy bulk importer still needs custom table/input coverage"),
            modern("OutgasserRecipes", "hbmIrradiation.json", Category.NUCLEAR, "outgasser",
                    "modern hbm_ntm_rebirth:outgasser serializer exists; legacy bulk importer is still separate work"),
            ...
            unsupported("CompressorRecipes", "hbmCompressor.json", Category.MACHINE,
                    "compressor has a dedicated runtime table; legacy bulk importer is still separate work"),
            ...
            modern("ExposureChamberRecipes", "hbmExposureChamber.json", Category.NUCLEAR, "exposure_chamber",
                    "modern hbm_ntm_rebirth:exposure_chamber serializer exists for datapack recipes; legacy expensive-mode branch remains datapack-deferred"),
