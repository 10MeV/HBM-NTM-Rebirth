...
public class HbmLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("advancements.hbm_ntm_rebirth.manhattan.title", "The Manhattan Project");
        ...
        add("advancements.hbm_ntm_rebirth.sulfuric.title", "I should not have dipped my balls in sulfuric acid.");
        add("advancements.hbm_ntm_rebirth.sulfuric.description", "");
        ...
        add("advancements.hbm_ntm_rebirth.radium.title", "MISTER INCREDIBLE");
        add("advancements.hbm_ntm_rebirth.radium.description", "YOU'RE FIRED FOR POURING RADIUM IN MY COFFEE!");
        ...
        add("advancements.hbm_ntm_rebirth.slimeball.title", "I should dip my balls in sulfuric acid.");
        add("advancements.hbm_ntm_rebirth.slimeball.description", "");
        add("advancements.hbm_ntm_rebirth.stratum.title", "Stratum");
        add("advancements.hbm_ntm_rebirth.stratum.description", "Hit the brakes, Mitts.");
        ...
        add("advancements.hbm_ntm_rebirth.digamma_feel.description", "My eyes are bleeding");
        add("advancements.hbm_ntm_rebirth.digamma_know.title", "THE TERROR OF KNOWING");
        add("advancements.hbm_ntm_rebirth.digamma_know.description", "what this world is about.");
        ...
        add("block.hbm_ntm_rebirth.rail_booster", "High Speed Booster Rail");
        add("block.hbm_ntm_rebirth.rail_highspeed", "High Speed Rail");
        add("block.hbm_ntm_rebirth.rail_narrow", "Narrow Gauge Cart Rail");
        add("block.hbm_ntm_rebirth.rail_wood", "Wooden Tracks");
        add("block.hbm_ntm_rebirth.det_miner", "Mining Charge");
        ...
        add("item.hbm_ntm_rebirth.ingot_steel_dusted", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_1", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_2", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_3", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_4", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_5", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_6", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_7", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_8", "Dusted Steel Ingot");
        add("item.hbm_ntm_rebirth.ingot_steel_dusted_9", "Dusted Steel Ingot");
        add("item.hot_dusted.forged", "Forged %s time(s)");
        ...
        add("item.hbm_ntm_rebirth.powder_power", "Energy Powder");
        ...
        add("item.hbm_ntm_rebirth.upgrade_muffler", "Muffler");
        ...
        add("item.hbm_ntm_rebirth.upgrade_fortune_1", "Fortune Upgrade Mk.I");
        add("item.hbm_ntm_rebirth.upgrade_fortune_2", "Fortune Upgrade Mk.II");
        add("item.hbm_ntm_rebirth.upgrade_fortune_3", "Fortune Upgrade Mk.III");
        add("item.hbm_ntm_rebirth.upgrade_smelter", "Smelter Upgrade");
        add("item.hbm_ntm_rebirth.upgrade_nullifier", "Scrap Destroyer Upgrade");
        add("item.hbm_ntm_rebirth.upgrade_shredder", "Shredder Upgrade");
        add("item.hbm_ntm_rebirth.upgrade_centrifuge", "Centrifuge Upgrade");
        add("item.hbm_ntm_rebirth.upgrade_crystallizer", "Crystallizer Upgrade");
        ...
        add("block.hbm_ntm_rebirth.deco_computer", "IBM Personal Computer 300PL");
        add("block.hbm_ntm_rebirth.vine_phosphor", "Phosphor Vines");
        add("block.hbm_ntm_rebirth.platemetal.base", "Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.black", "Black Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.white", "White Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.red", "Red Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.green", "Green Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.light_gray", "Light Gray Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.blue", "Blue Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.purple", "Purple Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.cyan", "Cyan Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.pink", "Pink Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.lime", "Lime Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.yellow", "Yellow Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.light_blue", "Light Blue Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.magenta", "Magenta Platemetal Block");
        add("block.hbm_ntm_rebirth.platemetal.orange", "Orange Platemetal Block");
        ...
        add("item.hbm_ntm_rebirth.stamp_stone_wire", "Wire Stamp (Stone)");
        add("item.hbm_ntm_rebirth.stamp_stone_circuit", "Circuit Stamp (Stone)");
        add("item.hbm_ntm_rebirth.stamp_iron_flat", "Flat Stamp (Iron)");
        add("item.hbm_ntm_rebirth.stamp_steel_flat", "Flat Stamp (Steel)");
        add("item.hbm_ntm_rebirth.stamp_steel_plate", "Plate Stamp (Steel)");
        add("item.hbm_ntm_rebirth.stamp_steel_wire", "Wire Stamp (Steel)");
        add("item.hbm_ntm_rebirth.stamp_steel_circuit", "Circuit Stamp (Steel)");
        add("item.hbm_ntm_rebirth.stamp_titanium_flat", "Flat Stamp (Titanium)");
        add("item.hbm_ntm_rebirth.stamp_titanium_plate", "Plate Stamp (Titanium)");
        add("item.hbm_ntm_rebirth.stamp_titanium_wire", "Wire Stamp (Titanium)");
        add("item.hbm_ntm_rebirth.stamp_titanium_circuit", "Circuit Stamp (Titanium)");
        add("item.hbm_ntm_rebirth.stamp_obsidian_flat", "Flat Stamp (Obsidian)");
        add("item.hbm_ntm_rebirth.stamp_obsidian_plate", "Plate Stamp (Obsidian)");
        add("item.hbm_ntm_rebirth.stamp_obsidian_wire", "Wire Stamp (Obsidian)");
        add("item.hbm_ntm_rebirth.stamp_obsidian_circuit", "Circuit Stamp (Obsidian)");
        add("item.hbm_ntm_rebirth.stamp_iron_wire", "Wire Stamp (Iron)");
        add("item.hbm_ntm_rebirth.stamp_iron_circuit", "Circuit Stamp (Iron)");
        add("item.hbm_ntm_rebirth.stamp_desh_flat", "Flat Stamp (Desh)");
        add("item.hbm_ntm_rebirth.stamp_desh_plate", "Plate Stamp (Desh)");
        add("item.hbm_ntm_rebirth.stamp_desh_wire", "Wire Stamp (Desh)");
        add("item.hbm_ntm_rebirth.stamp_desh_circuit", "Circuit Stamp (Desh)");
        add("item.hbm_ntm_rebirth.stamp_357", ".357 Magnum Stamp");
        add("item.hbm_ntm_rebirth.stamp_desh_357", ".357 Magnum Stamp (Desh)");
        add("item.hbm_ntm_rebirth.stamp_44", ".44 Magnum Stamp");
        add("item.hbm_ntm_rebirth.stamp_desh_44", ".44 Magnum Stamp (Desh)");
        add("item.hbm_ntm_rebirth.stamp_50", "Large Caliber Stamp");
        add("item.hbm_ntm_rebirth.stamp_desh_50", "Large Caliber Stamp (Desh)");
        add("item.hbm_ntm_rebirth.stamp_9", "Small Caliber Stamp");
        add("item.hbm_ntm_rebirth.stamp_desh_9", "Small Caliber Stamp (Desh)");
        ...
        add("item.hbm_ntm_rebirth.iv_empty", "IV Bag");
        ...
        add("item.hbm_ntm_rebirth.stealth_boy", "Stealth Device");
        add("item.hbm_ntm_rebirth.cigarette", "FFI-Brand Cigarette");
        add("item.hbm_ntm_rebirth.crackpipe", "Health Pipe");
        add("item.hbm_ntm_rebirth.crowbar", "Mk.V Crate Opening Device \"Crowbar\"");
        add("item.hbm_ntm_rebirth.wood_gavel", "Wooden Gavel");
        add("item.hbm_ntm_rebirth.wood_gavel.desc", "Thunk!");
        add("item.hbm_ntm_rebirth.lead_gavel", "Leaden Gavel");
        add("item.hbm_ntm_rebirth.lead_gavel.desc", "You are hereby sentenced to lead poisoning.");
        add("item.hbm_ntm_rebirth.pipe_lead", "The Manual Override");
        add("item.hbm_ntm_rebirth.pipe_lead.desc", "I'm going to attempt a manual override on this wall.");
        add("item.hbm_ntm_rebirth.ullapool_caber", "Ullapool Caber");
        ...
        add("item.hbm_ntm_rebirth.med_bag", "First Aid Kit");
        ...
        add("item.hbm_ntm_rebirth.syringe_empty", "Empty Syringe");
        add("item.hbm_ntm_rebirth.syringe_antidote", "Antidote");
        add("item.hbm_ntm_rebirth.syringe_antidote.desc.0", "Removes all potion effects");
        add("item.hbm_ntm_rebirth.syringe_poison", "Poisonous Injection");
        add("item.hbm_ntm_rebirth.syringe_poison.desc.0", "Deadly");
        add("item.hbm_ntm_rebirth.syringe_awesome", "AWESOME");
        ...
        add("item.hbm_ntm_rebirth.bottle_empty", "Empty Bomb-Shaped Bottle");
        ...
        add("item.hbm_ntm_rebirth.flask_infusion", "Shield Infusion");
        ...
        add("item.hbm_ntm_rebirth.bottle_sparkle", "Bottle of S~Cola");
        add("item.hbm_ntm_rebirth.bottle_sparkle.desc.0", "The most delicious beverage in the wasteland!");
        add("item.hbm_ntm_rebirth.bottle_rad", "Bottle of S~Cola RAD");
        ...
        add("item.hbm_ntm_rebirth.bottle2_fritz", "Fritz Cola");
        ...
        add("item.hbm_ntm_rebirth.bottle_opener", "Hbm's Own Self-Made Bottle Opener");
        ...
        add("item.hbm_ntm_rebirth.can_key", "Winding Key");
        add("item.hbm_ntm_rebirth.ring_pull", "Ring Pull");
        add("item.hbm_ntm_rebirth.can_smart", "'Smart' Energy Drink");
        add("item.hbm_ntm_rebirth.can_smart.desc.0", "Cheap and full of bubbles");
        add("item.hbm_ntm_rebirth.can_creature", "'Creature' Energy Drink");
        add("item.hbm_ntm_rebirth.can_creature.desc.0", "Basically gasoline in a tin can");
        add("item.hbm_ntm_rebirth.can_redbomb", "'Red Bomb' Energy Drink");
        add("item.hbm_ntm_rebirth.can_redbomb.desc.0", "Liquefied explosives");
        add("item.hbm_ntm_rebirth.can_mrsugar", "'Dr. Sugar' Soft Drink");
        add("item.hbm_ntm_rebirth.can_mrsugar.desc.0", "An intellectual drink, for the chosen ones!");
        add("item.hbm_ntm_rebirth.can_overcharge", "Overcharge Delirium XT");
        ...
        add("item.hbm_ntm_rebirth.canned_asbestos", "Canned Asbestos");
        add("item.hbm_ntm_rebirth.canned_asbestos.desc.0", "TASTE the asbestosis!");
        add("item.hbm_ntm_rebirth.canned_ass", "Canned Ass");
        add("item.hbm_ntm_rebirth.canned_ass.desc.0", "100%% quality donkey meat!*");
        add("item.hbm_ntm_rebirth.canned_bark", "Canned Pine Bark Jerky");
        add("item.hbm_ntm_rebirth.canned_bark.desc.0", "Extra cronchy!");
        add("item.hbm_ntm_rebirth.canned_beef", "Canned Beef");
        add("item.hbm_ntm_rebirth.canned_beef.desc.0", "A few centuries ago, a cow died for this.");
        add("item.hbm_ntm_rebirth.canned_bhole", "Canned Black Hole");
        add("item.hbm_ntm_rebirth.canned_bhole.desc.0", "Made from actual singularities. No, really.");
        add("item.hbm_ntm_rebirth.canned_cheese", "Canned Melted Cheese");
        add("item.hbm_ntm_rebirth.canned_cheese.desc.0", "Is it cheese? Is it rubber cement? Who knows, who cares.");
        add("item.hbm_ntm_rebirth.canned_chinese", "Canned Chinese Food");
        add("item.hbm_ntm_rebirth.canned_chinese.desc.0", "In China, Chinese food is just called food.");
        add("item.hbm_ntm_rebirth.canned_diesel", "Canned Diesel");
        add("item.hbm_ntm_rebirth.canned_diesel.desc.0", "I'm slowly running out of jokes for these.");
        add("item.hbm_ntm_rebirth.canned_fist", "Canned Fist");
        add("item.hbm_ntm_rebirth.canned_fist.desc.0", "ow");
        add("item.hbm_ntm_rebirth.canned_fried", "Canned Fried Chicken");
        add("item.hbm_ntm_rebirth.canned_fried.desc.0", "Even the can is deep fried!");
        add("item.hbm_ntm_rebirth.canned_hotdogs", "Canned Hotdogs");
        add("item.hbm_ntm_rebirth.canned_hotdogs.desc.0", "Not to be confused with cool cats.");
        add("item.hbm_ntm_rebirth.canned_kerosene", "Canned Kerosene");
        add("item.hbm_ntm_rebirth.canned_kerosene.desc.0", "Just imagine a witty line here.");
        add("item.hbm_ntm_rebirth.canned_leftovers", "Leftover Conserve");
        add("item.hbm_ntm_rebirth.canned_leftovers.desc.0", "ur 2 slow");
        add("item.hbm_ntm_rebirth.canned_milk", "Canned Evaporated Milk");
        add("item.hbm_ntm_rebirth.canned_milk.desc.0", "Milk 2: More solid than ever before!");
        add("item.hbm_ntm_rebirth.canned_mystery", "Canned Mystery Meat");
        add("item.hbm_ntm_rebirth.canned_mystery.desc.0", "What's inside? Only one way to find out!");
        add("item.hbm_ntm_rebirth.canned_napalm", "Canned Napalm");
        add("item.hbm_ntm_rebirth.canned_napalm.desc.0", "I love the smell of old memes in the morning!");
        add("item.hbm_ntm_rebirth.canned_oil", "Canned Engine Oil");
        add("item.hbm_ntm_rebirth.canned_oil.desc.0", "It makes motors go, so why not humans?");
        add("item.hbm_ntm_rebirth.canned_pashtet", "\u041f\u0430\u0448\u0442\u0435\u0442");
        add("item.hbm_ntm_rebirth.canned_pashtet.desc.0",
                "\u0443\u0441\u043b\u0443\u0433\u0438 \u043f\u0435\u0440\u0435\u0432\u043e\u0434\u0430 \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u044b!");
        add("item.hbm_ntm_rebirth.canned_pizza", "Canned Pepperoni Pizza");
        add("item.hbm_ntm_rebirth.canned_pizza.desc.0", "A crime against humanity.");
        add("item.hbm_ntm_rebirth.canned_recursion", "Canned Recursion");
        add("item.hbm_ntm_rebirth.canned_recursion.desc.0", "Canned Recursion");
        add("item.hbm_ntm_rebirth.canned_spam", "Canned Spam");
        add("item.hbm_ntm_rebirth.canned_spam.desc.0", "The three-and-a-half-minute sketch is set in the fictional Green Midget Cafe in Bromley.");
        add("item.hbm_ntm_rebirth.canned_spam.desc.1", "An argument develops between the waitress, who recites a menu in which nearly");
        add("item.hbm_ntm_rebirth.canned_spam.desc.2", "every dish contains Spam, and Mrs. Bun, who does not like Spam. She asks for a");
        add("item.hbm_ntm_rebirth.canned_spam.desc.3", "dish without Spam, much to the amazement of her Spam-loving husband. The waitress");
        add("item.hbm_ntm_rebirth.canned_spam.desc.4", "responds to this request with disgust. Mr. Bun offers to take her Spam instead,");
        add("item.hbm_ntm_rebirth.canned_spam.desc.5", "and asks for a dish containing a lot of Spam and baked beans. The waitress says");
        add("item.hbm_ntm_rebirth.canned_spam.desc.6", "no since they are out of baked beans; when Mr. Bun asks for a substitution of Spam,");
        add("item.hbm_ntm_rebirth.canned_spam.desc.7", "the waitress again responds with disgust. At several points, a group of Vikings in");
        add("item.hbm_ntm_rebirth.canned_spam.desc.8", "the restaurant interrupts conversation by loudly singing about Spam.");
        add("item.hbm_ntm_rebirth.canned_spam.desc.9", "The irate waitress orders them to shut up, but they resume singing more loudly.");
        add("item.hbm_ntm_rebirth.canned_spam.desc.10", "A Hungarian tourist comes to the counter, trying to order by using a wholly");
        add("item.hbm_ntm_rebirth.canned_spam.desc.11", "inaccurate Hungarian/English phrasebook (a reference to a previous sketch).");
        add("item.hbm_ntm_rebirth.canned_spam.desc.12", "He is rapidly escorted away by a police constable. The sketch abruptly cuts to a");
        add("item.hbm_ntm_rebirth.canned_spam.desc.13", "historian in a television studio talking about the origin of the Vikings in the caf\u00e9.");
        add("item.hbm_ntm_rebirth.canned_spam.desc.14", "As he goes on, he begins to increasingly insert the word \"Spam\" into every");
        add("item.hbm_ntm_rebirth.canned_spam.desc.15", "sentence, and the backdrop is raised to reveal the restaurant set behind.");
        add("item.hbm_ntm_rebirth.canned_spam.desc.16", "The historian joins the Vikings in their song, and Mr. and Mrs. Bun are lifted by");
        add("item.hbm_ntm_rebirth.canned_spam.desc.17", "wires out of the scene while the singing continues. In the original televised performance,");
        add("item.hbm_ntm_rebirth.canned_spam.desc.18", "the closing credits begin to scroll with the singing still audible in the background.");
        add("item.hbm_ntm_rebirth.canned_stew", "Canned \"Mushroom Stew\"");
        add("item.hbm_ntm_rebirth.canned_stew.desc.0", "...");
        add("item.hbm_ntm_rebirth.canned_tomato", "Canned Tomato Soup");
        add("item.hbm_ntm_rebirth.canned_tomato.desc.0", "Who wants some thick red paste?");
        add("item.hbm_ntm_rebirth.canned_tube", "Astronaut Food Tube");
        add("item.hbm_ntm_rebirth.canned_tube.desc.0", "Tasty mush.");
        add("item.hbm_ntm_rebirth.canned_tuna", "Canned Tuna");
        add("item.hbm_ntm_rebirth.canned_tuna.desc.0", "I can't tell if that's actually tuna or dried cement.");
        add("item.hbm_ntm_rebirth.canned_yogurt", "Canned Yogurt");
        add("item.hbm_ntm_rebirth.canned_yogurt.desc.0", "Probably spoiled, but whatever.");
        add("item.hbm_ntm_rebirth.canned_slime", "Condensed Horse Slime");
        add("item.hbm_ntm_rebirth.canned_slime.desc", "Now with extra bone marrow.");
        add("item.hbm_ntm_rebirth.canned_slime.desc.0", "Now with extra bone marrow.");
        ...
        add("item.hbm_ntm_rebirth.nugget", "Chicken Nugget");
        add("item.hbm_ntm_rebirth.bomb_waffle", "Waffle of Mass Destruction");
        add("item.hbm_ntm_rebirth.schnitzel_vegan", "Vegan Schnitzel");
        add("item.hbm_ntm_rebirth.cotton_candy", "Radioactive Cotton Candy");
        add("item.hbm_ntm_rebirth.apple_lead", "Lead Apple");
        add("item.hbm_ntm_rebirth.apple_lead_ingot", "Lead Apple");
        add("item.hbm_ntm_rebirth.apple_lead_block", "Lead Apple");
        add("item.hbm_ntm_rebirth.apple_schrabidium", "Schrabidium Apple");
        add("item.hbm_ntm_rebirth.apple_schrabidium_ingot", "Schrabidium Apple");
        add("item.hbm_ntm_rebirth.apple_schrabidium_block", "Schrabidium Apple");
        add("item.hbm_ntm_rebirth.apple_euphemium", "Euphemium Apple");
        add("item.hbm_ntm_rebirth.pancake", "Pancake made from Scrap Metal, Nails and Gem Dust");
        add("item.hbm_ntm_rebirth.coffee", "Coffee");
        add("item.hbm_ntm_rebirth.coffee_radium", "Radium Coffee");
        add("item.hbm_ntm_rebirth.chocolate_milk", "Chocolate Milk");
        ...
        add("item.hbm_ntm_rebirth.lemon", "\"Lemon\"");
        add("item.hbm_ntm_rebirth.lemon.desc", "Eh, good enough.");
        add("item.hbm_ntm_rebirth.pudding", "Pudding");
        add("item.hbm_ntm_rebirth.pudding.desc.0", "What if he did?");
        add("item.hbm_ntm_rebirth.pudding.desc.1", "What if he didn't?");
        add("item.hbm_ntm_rebirth.pudding.desc.2", "What if the world was made of pudding?");
        add("item.hbm_ntm_rebirth.spongebob_macaroni", "Spongebob Macaroni");
        add("item.hbm_ntm_rebirth.static_sandwich", "Sandwich Garnished with TV Static");
        ...
        add("item.hbm_ntm_rebirth.rune_blank", "Blank Catalyst Matrix");
        add("item.hbm_ntm_rebirth.rune_isa", "Cool Catalyst Matrix");
        add("item.hbm_ntm_rebirth.rune_dagaz", "Balanced Catalyst Matrix");
        add("item.hbm_ntm_rebirth.rune_hagalaz", "Rough Catalyst Matrix");
        add("item.hbm_ntm_rebirth.rune_jera", "Multiplicative Catalyst Matrix");
        add("item.hbm_ntm_rebirth.rune_thurisaz", "Additive Catalyst Matrix");
        add("item.hbm_ntm_rebirth.cheese", "Cheese");
        add("item.hbm_ntm_rebirth.quesadilla", "Cheese Quesadilla");
        add("item.hbm_ntm_rebirth.quesadilla.desc", "That's what a 50 year old yeast infection does to you.");
        add("item.hbm_ntm_rebirth.mucho_mango", "AriZona Mucho Mango");
        add("item.hbm_ntm_rebirth.mucho_mango.desc", "The Comically Large Can");
        add("item.hbm_ntm_rebirth.med_ipecac", "Ipecac Syrup");
        add("item.hbm_ntm_rebirth.med_ipecac.desc.0", "Bitter juice that will cause your stomach");
        add("item.hbm_ntm_rebirth.med_ipecac.desc.1", "to forcefully eject its contents.");
        add("item.hbm_ntm_rebirth.med_ptsd", "PTSD Medication");
        add("item.hbm_ntm_rebirth.med_ptsd.desc.0", "This isn't even PTSD medication, it's just");
        add("item.hbm_ntm_rebirth.med_ptsd.desc.1", "Ipecac in a different bottle!");
        add("item.hbm_ntm_rebirth.ingot_smore", "S'more Ingot");
        ...
        add("item.hbm_ntm_rebirth.tem_flakes", "Tem Flakes");
        add("item.hbm_ntm_rebirth.glowing_stew", "Glowing Mushroom Stew");
        add("item.hbm_ntm_rebirth.balefire_scrambled", "Scrambled Balefire Egg");
        add("item.hbm_ntm_rebirth.balefire_and_ham", "Ham and Balefire Eggs");
        add("item.hbm_ntm_rebirth.peas", "Peas");
        add("item.hbm_ntm_rebirth.peas.desc", "He accepts your offering.");
        add("item.hbm_ntm_rebirth.spawn_duck", "Golden Egg");
        add("item.hbm_ntm_rebirth.marshmallow", "Marshmallow on a Stick");
        add("item.hbm_ntm_rebirth.book_lemegeton", "Lemegeton");
        add("container.hbm_ntm_rebirth.lemegeton", "Material Upgrade Conversion");
        ...
        add("item.hbm_ntm_rebirth.egg_glyphid", "Glyphid Egg");
        ...
        add("item.hbm_ntm_rebirth.beta", "Beta Features");
        ...
        add("item.hbm_ntm_rebirth.item_secret_selenium_steel", "Selenium Steel");
        ...
        add("item.hbm_ntm_rebirth.key", "Key");
        add("item.hbm_ntm_rebirth.key_fake", "Counterfeit Key");
        add("item.hbm_ntm_rebirth.key_kit", "Key Imitation Kit");
        add("item.hbm_ntm_rebirth.key_kit.desc", "Use on a locked container to create two counterfeit keys!");
        add("item.hbm_ntm_rebirth.pin", "Bobby Pin");
        add("item.hbm_ntm_rebirth.pin.desc", "Standard success rate of picking a regular lock is ~10%%.");
        add("item.hbm_ntm_rebirth.padlock", "Padlock");
        add("item.hbm_ntm_rebirth.padlock_reinforced", "Reinforced Padlock");
        add("item.hbm_ntm_rebirth.padlock_rusty", "Rusty Padlock");
        add("item.hbm_ntm_rebirth.padlock_unbreakable", "Unbreakable Padlock");
        ...
        add("item.hbm_ntm_rebirth.schrabidium_hoe", "Schrabidium Hoe");
        add("item.hbm_ntm_rebirth.schrabidium_hammer", "Schrabidium Hammer");
        ...
        add("item.hbm_ntm_rebirth.titanium_hoe", "Titanium Hoe");
        add("item.hbm_ntm_rebirth.steel_sword", "Steel Sword");
        add("item.hbm_ntm_rebirth.redstone_sword", "Redstone Sword");
        add("block.hbm_ntm_rebirth.ladder_sturdy", "Sturdy Wooden Ladder");
        add("block.hbm_ntm_rebirth.ladder_gold", "Gold Ladder");
        add("block.hbm_ntm_rebirth.ladder_copper", "Copper Ladder");
        add("block.hbm_ntm_rebirth.ladder_titanium", "Titanium Ladder");
        add("block.hbm_ntm_rebirth.ladder_steel", "Steel Ladder");
        add("block.hbm_ntm_rebirth.trapdoor_steel", "Steel Trapdoor");
        add("item.hbm_ntm_rebirth.reer_graar", "The Reer Graar");
        add("item.hbm_ntm_rebirth.wrench_archineer", "Archineer's Wrench");
        add("item.hbm_ntm_rebirth.wrench_flipped", "Blade on a Wrench");
        add("item.hbm_ntm_rebirth.memespoon", "\u00a7eMarket Gardener");
        ...
        add("item.hbm_ntm_rebirth.steel_hoe", "Steel Hoe");
        ...
        add("item.hbm_ntm_rebirth.cmb_hoe", "CMB Steel Hoe");
        ...
        add("item.hbm_ntm_rebirth.desh_hoe", "Desh Hoe");
        ...
        add("item.hbm_ntm_rebirth.cobalt_hoe", "Cobalt Hoe");
        ...
        add("item.hbm_ntm_rebirth.cobalt_decorated_hoe", "Decorated Cobalt Hoe");
        ...
        add("item.hbm_ntm_rebirth.starmetal_hoe", "Starmetal Hoe");
        ...
        add("item.hbm_ntm_rebirth.matchstick", "Matchstick");
        add("item.hbm_ntm_rebirth.screwdriver_desh", "Desh Screwdriver");
        add("item.hbm_ntm_rebirth.hand_drill_desh", "Desh Hand Drill");
        add("item.hbm_ntm_rebirth.analysis_tool", "Analysis Tool");
        add("item.hbm_ntm_rebirth.chemistry_set", "Laboratory Glassware");
        add("item.hbm_ntm_rebirth.chemistry_set_boron", "Laboratory Glassware (Boron Glass)");
        ...
        add("item.hbm_ntm_rebirth.bucket_mud", "Bucket of Poisonous Mud");
        add("item.hbm_ntm_rebirth.bucket_acid", "Bucket of Acid");
        add("item.hbm_ntm_rebirth.bucket_toxic", "Bucket of Stereotypical Green Ooze");
        add("item.hbm_ntm_rebirth.bucket_schrabidic_acid", "Bucket of Schrabidic Acid");
        add("item.hbm_ntm_rebirth.bucket_sulfuric_acid", "Bucket of Sulfuric Acid");
        ...
        add("item.hbm_ntm_rebirth.bio_wafer", "Algae Wafer");
        ...
        add("item.hbm_ntm_rebirth.siphon", "Siphon");
        add("item.hbm_ntm_rebirth.pipette", "Pipette");
        add("item.hbm_ntm_rebirth.pipette_boron", "Boron Pipette");
        add("item.hbm_ntm_rebirth.pipette_laboratory", "Laboratory Grade Pipette");
        add("desc.item.pipette.corrosive", "Can handle corrosive liquids.");
        ...
        add("block.hbm_ntm_rebirth.capacitor_copper", "Old Capacitor");
        add("block.hbm_ntm_rebirth.capacitor_gold", "Golden Capacitor (LEGACY)");
        add("block.hbm_ntm_rebirth.capacitor_niobium", "Niobium Capacitor (LEGACY)");
        add("block.hbm_ntm_rebirth.capacitor_tantalium", "Tantalum Capacitor (LEGACY)");
        add("block.hbm_ntm_rebirth.capacitor_schrabidate", "Schrabidate Capacitor (LEGACY)");
        add("item.hbm_ntm_rebirth.capacitor_copper_block", "Old Capacitor");
        add("item.hbm_ntm_rebirth.capacitor_gold_block", "Golden Capacitor (LEGACY)");
        add("item.hbm_ntm_rebirth.capacitor_niobium_block", "Niobium Capacitor (LEGACY)");
        add("item.hbm_ntm_rebirth.capacitor_tantalium_block", "Tantalum Capacitor (LEGACY)");
        add("item.hbm_ntm_rebirth.capacitor_schrabidate_block", "Schrabidate Capacitor (LEGACY)");
        ...
        add("block.hbm_ntm_rebirth.pwr_casing.desc", "Needs to cover all internal parts for the reactor to form$Placement: Casing");
        add("block.hbm_ntm_rebirth.pwr_channel.desc", "Uses hull heat to heat up coolant$Placement: Any");
        add("block.hbm_ntm_rebirth.pwr_control.desc", "Allows connected fuel rods to be controlled$Placement: Grid, between fuel rods");
        add("block.hbm_ntm_rebirth.pwr_controller.desc", "Access terminal for the PWR$Placement: Casing, only one per reactor$Right-click to assemble the reactor");
        add("block.hbm_ntm_rebirth.pwr_fuel.desc", "Increases PWR fuel capacity$Placement: Grid, for increased reactivity");
        add("block.hbm_ntm_rebirth.pwr_heatex.desc", "Moves core heat to the hull$Placement: Any");
        add("block.hbm_ntm_rebirth.pwr_heatsink.desc", "Increases core heat capacity by 5%%$Makes coolant channels and heat exchangers slightly less effective$Placement: Any");
        add("block.hbm_ntm_rebirth.pwr_neutron_source.desc", "Adds 20 flux to the core$Placement: Any$Flux only reaches fuel rods if connections are open");
        add("block.hbm_ntm_rebirth.pwr_port.desc", "Allows item and fluid IO$Placement: Casing");
        add("block.hbm_ntm_rebirth.pwr_reflector.desc", "Reflects neutrons back to fuel rods$Placement: Grid, for increased reactivity$Valid casing material");
        add("block.hbm_ntm_rebirth.machine_icf_press.desc", "Fills ICF Fuel pellets$Left fuel slot is accepted by top/bottom, right by the sides$Muons and pellets may be supplied from any side");
        ...
        add("item.hbm_ntm_rebirth.turret_chip.added", "Added player data!");
        ...
        add("block.hbm_ntm_rebirth.crate_desh", "Desh Crate");
        add("block.hbm_ntm_rebirth.crate_tungsten", "Tungsten Crate");
        add("block.hbm_ntm_rebirth.safe", "Safe");
        add("block.hbm_ntm_rebirth.mass_storage", "Mass Storage Unit");
        add("container.crateIron", "Iron Crate");
        add("container.crateSteel", "Steel Crate");
        add("container.crateDesh", "Desh Crate");
        add("container.crateTungsten", "Tungsten Crate");
        add("container.safe", "Safe");
        add("container.massStorage", "Storage");
        ...
        add("block.hbm_ntm_rebirth.vault_door", "Vault-Tec Blast Door");
        add("block.hbm_ntm_rebirth.blast_door", "Sliding Blast Door");
        add("block.hbm_ntm_rebirth.fire_door", "Fire Door");
        add("block.hbm_ntm_rebirth.transition_seal", "Transition Seal");
        add("block.hbm_ntm_rebirth.sliding_blast_door", "Sliding Blast Door");
        add("block.hbm_ntm_rebirth.large_vehicle_door", "Large Vehicle Door");
        add("block.hbm_ntm_rebirth.water_door", "Water Door");
        add("block.hbm_ntm_rebirth.qe_containment", "QE Containment Door");
        add("block.hbm_ntm_rebirth.qe_sliding_door", "QE Sliding Door");
        add("block.hbm_ntm_rebirth.round_airlock_door", "Round Airlock Door");
        add("block.hbm_ntm_rebirth.secure_access_door", "Secure Access Door");
        add("block.hbm_ntm_rebirth.sliding_seal_door", "Sliding Seal Door");
        add("block.hbm_ntm_rebirth.silo_hatch", "Silo Hatch");
        add("block.hbm_ntm_rebirth.silo_hatch_large", "Large Silo Hatch");
        ...
        add("item.hbm_ntm_rebirth.detonator_multi", "Multi Detonator");
        add("item.hbm_ntm_rebirth.detonator_laser", "Laser Detonator");
        ...
        add("item.hbm_ntm_rebirth.particle_lutece", "Lutece Quasiparticle");
        ...
        add("block.hbm_ntm_rebirth.machine_turbine.desc", "Efficiency: 85%%");
        add("block.hbm_ntm_rebirth.machine_industrial_turbine", "Industrial Steam Turbine");
        add("block.hbm_ntm_rebirth.machine_industrial_turbine.desc", "Efficiency: 100%%");
        add("block.hbm_ntm_rebirth.machine_large_turbine", "Industrial Steam Turbine (LEGACY)");
        add("block.hbm_ntm_rebirth.machine_large_turbine.desc", "Efficiency: 100%%");
        add("container.machineLargeTurbine", "Industrial Steam Turbine");
        ...
        add("block.hbm_ntm_rebirth.red_pylon_steel", "Steel Electricity Pylon");
        ...
        add("block.hbm_ntm_rebirth.rbmk_display_blank.desc", "Cheap panel for extending RoR control panels.");
        add("block.hbm_ntm_rebirth.rbmk_display", "RBMK Display Panel");
        add("block.hbm_ntm_rebirth.rbmk_display.desc", "Can be linked with the RBMK console linking device.$Shows a 7x7 segment of the RBMK.$View can be rotated with a screwdriver.");
        add("block.hbm_ntm_rebirth.rbmk_gauge", "Redstone-over-Radio Gauge");
        add("block.hbm_ntm_rebirth.rbmk_gauge.desc", "Can be configured with a screwdriver.$Displays up to four numeric values from different$RoR signal sources.");
        add("block.hbm_ntm_rebirth.rbmk_graph", "Redstone-over-Radio Graph");
        add("block.hbm_ntm_rebirth.rbmk_graph.desc", "Can be configured with a screwdriver.$Logs and displays up to two numeric values$from different RoR signal sources.");
        add("block.hbm_ntm_rebirth.rbmk_indicator", "Redstone-over-Radio Indicator Lights");
        add("block.hbm_ntm_rebirth.rbmk_indicator.desc", "Can be configured with a screwdriver.$Can have up to six indicators that will$light up when an RoR value falls$within the configured threshold.");
        add("block.hbm_ntm_rebirth.rbmk_key_pad", "Redstone-over-Radio Keypad");
        add("block.hbm_ntm_rebirth.rbmk_key_pad.desc", "Can be configured with a screwdriver.$Allows up to four different buttons which can$send RoR signals when pressed.");
        add("block.hbm_ntm_rebirth.rbmk_lever", "Redstone-over-Radio Lever");
        add("block.hbm_ntm_rebirth.rbmk_lever.desc", "Can be configured with a screwdriver.$Allows up to two levers which can send$RoR signals in either position.");
        add("block.hbm_ntm_rebirth.rbmk_numitron", "Redstone-over-Radio Numeric Display");
        add("block.hbm_ntm_rebirth.rbmk_numitron.desc", "Can be configured with a screwdriver.$Displays up to two numeric values$from different RoR signal sources.");
        add("block.hbm_ntm_rebirth.rbmk_terminal", "Redstone-over-Radio Terminal");
        add("block.hbm_ntm_rebirth.rbmk_terminal.desc", "Allos RoR commands to be sent manually.");
        ...
        add("block.hbm_ntm_rebirth.fluid_duct_gauge.desc", "Pipe that displays how much fluid$moves within the network per tick.$Split networks connected by barrels$or tanks are considered as one shared network.");
        ...
        add("block.hbm_ntm_rebirth.fluid_duct_paintable.desc", "Right-click with a solid block to set a paint$Paint can be cleared with a screwdriver$Port texture can be disabled with a defuser$Paints can be copied with the copy tool");
        add("block.hbm_ntm_rebirth.fluid_duct_paintable_block_exhaust", "Paintable Coated Exhaust Pipe");
        add("block.hbm_ntm_rebirth.fluid_duct_paintable_block_exhaust.desc", "Right-click with a solid block to set a paint$Paint can be cleared with a screwdriver$Port texture can be disabled with a defuser$Paints can be copied with the copy tool");
        ...
        add("block.hbm_ntm_rebirth.machine_schrabidium_battery", "Schrabidium Energy Storage Block (LEGACY)");
        add("block.hbm_ntm_rebirth.machine_dineutronium_battery", "Spark Energy Storage Block (LEGACY)");
        ...
        add("block.hbm_ntm_rebirth.struct_launcher_core", "Compact Launcher Core Component");
        add("block.hbm_ntm_rebirth.struct_launcher_core_large", "Launch Table Core Component");
        ...
        add("item.hbm_ntm_rebirth.linker", "Telelinker");
        ...
        add("container.forceField", "Forcefield Emitter");
        add("block.hbm_ntm_rebirth.machine_assembly_machine", "Assembly Machine");
        add("block.hbm_ntm_rebirth.machine_teleporter", "Teleporter");
        ...
        add("block.hbm_ntm_rebirth.pole_top", "Antenna Top");
        add("block.hbm_ntm_rebirth.pole_satellite_receiver", "Satellite Dish");
        ...
        add("item.hbm_ntm_rebirth.bedrock_ore_base", "Raw Bedrock Ore");
        add("item.hbm_ntm_rebirth.bedrock_ore_fragment", "%s Bedrock Ore Fragment");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.base.name", "%s Bedrock Ore");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.base_roasted.name", "Roasted %s Bedrock Ore");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.base_washed.name", "Washed %s Bedrock Ore");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary.name", "%s Bedrock Ore, Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_roasted.name", "%s Bedrock Ore, Roasted Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_sulfuric.name", "%s Bedrock Ore, Sulfuric Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_nosulfuric.name", "%s Bedrock Ore, Separated Sulfuric Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_solvent.name", "%s Bedrock Ore, Dissolved Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_nosolvent.name", "%s Bedrock Ore, Separated Dissolved Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_rad.name", "%s Bedrock Ore, Cleaned Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_norad.name", "%s Bedrock Ore, Separated Cleaned Primary Fraction");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_first.name", "%s Bedrock Ore, Primary Fraction, Higher Weight");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.primary_second.name", "%s Bedrock Ore, Primary Fraction, Lower Weight");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.crumbs.name", "%s Bedrock Ore Crumbs");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.sulfuric_byproduct.name", "%s Bedrock Ore, Sulfuric Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.sulfuric_roasted.name", "%s Bedrock Ore, Roasted Sulfuric Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.sulfuric_arc.name", "%s Bedrock Ore, Seared Sulfuric Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.sulfuric_washed.name", "%s Bedrock Ore, Washed Sulfuric Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.solvent_byproduct.name", "%s Bedrock Ore, Dissolved Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.solvent_roasted.name", "%s Bedrock Ore, Roasted Dissolved Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.solvent_arc.name", "%s Bedrock Ore, Seared Dissolved Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.solvent_washed.name", "%s Bedrock Ore, Washed Dissolved Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.rad_byproduct.name", "%s Bedrock Ore, Cleaned Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.rad_roasted.name", "%s Bedrock Ore, Roasted Cleaned Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.rad_arc.name", "%s Bedrock Ore, Seared Cleaned Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.grade.rad_washed.name", "%s Bedrock Ore, Washed Cleaned Byproduct");
        add("item.hbm_ntm_rebirth.bedrock_ore.trait.arc", "\u00a76Arc Smelted");
        add("item.hbm_ntm_rebirth.bedrock_ore.trait.centrifuged", "\u00a79Centrifuged");
        add("item.hbm_ntm_rebirth.bedrock_ore.trait.rad", "\u00a7aTreated with High-Performance Solvent");
        add("item.hbm_ntm_rebirth.bedrock_ore.trait.roasted", "\u00a7eCombination Oven Roasted");
        add("item.hbm_ntm_rebirth.bedrock_ore.trait.solvent", "\u00a7fTreated with Solvent");
        add("item.hbm_ntm_rebirth.bedrock_ore.trait.sulfuric", "\u00a76Treated with Sulfuric Acid");
        add("item.hbm_ntm_rebirth.bedrock_ore.trait.washed", "\u00a7bWashed");
        add("item.hbm_ntm_rebirth.bedrock_ore.type.actinide.name", "Actinide");
        add("item.hbm_ntm_rebirth.bedrock_ore.type.crystal.name", "Crystalline");
        add("item.hbm_ntm_rebirth.bedrock_ore.type.heavy.name", "Heavy Metal");
        add("item.hbm_ntm_rebirth.bedrock_ore.type.light.name", "Light Metal");
        ...
        add("block.hbm_ntm_rebirth.watz_end_riveted", "Watz Reactor Stability Element (Riveted)");
        ...
        add("block.hbm_ntm_rebirth.fusion_klystron", "Klystron");
        add("block.hbm_ntm_rebirth.fusion_klystron.desc", "Power source for fusion reactors.$Requires cooling via compressed air.");
        add("block.hbm_ntm_rebirth.fusion_klystron_creative", "Creative Klystron");
        add("block.hbm_ntm_rebirth.fusion_klystron_creative.desc", "Provides infinite klystron energy.");
        add("block.hbm_ntm_rebirth.fusion_breeder", "Fusion Reactor Breeding Chamber");
        add("block.hbm_ntm_rebirth.fusion_breeder.desc", "Uses output neutron flux from$a fusion reactor to process materials.$Useful for making tritium fuel.");
        add("block.hbm_ntm_rebirth.fusion_collector", "Fusion Reactor Collector Chamber");
        add("block.hbm_ntm_rebirth.fusion_collector.desc", "Can be connected to the main vessel$to increase byproduct yield.");
        add("block.hbm_ntm_rebirth.fusion_boiler", "Fusion Reactor Boiler");
        add("block.hbm_ntm_rebirth.fusion_boiler.desc", "Uses plasma energy from a fusion reactor$to boil water into super dense steam.");
        add("block.hbm_ntm_rebirth.fusion_component_bscco", "Superconducting BSCCO Coils");
        add("block.hbm_ntm_rebirth.fusion_component_bscco_welded", "Welded BSCCO Coils");
        add("block.hbm_ntm_rebirth.fusion_component_blanket", "Fusion Reactor Blanket");
        add("block.hbm_ntm_rebirth.fusion_component_motor", "Fusion Reactor Piping");
        add("block.hbm_ntm_rebirth.fusion_coupler", "Fusion Reactor Plasma Coupler");
        add("block.hbm_ntm_rebirth.fusion_coupler.desc", "Turns plasma output energy into$klystron energy, which can be used in a$second plasma vessel to ignite plasma.");
        add("block.hbm_ntm_rebirth.fusion_mhdt", "MHD Turbine");
        add("block.hbm_ntm_rebirth.fusion_mhdt.desc", "Turns plasma energy into usable$electricity directly. More efficient$than a conventional boiler.$Requires cooling!");
        add("block.hbm_ntm_rebirth.fusion_plasma_forge", "Plasma Forge");
        add("container.reactorResearch", "Research Reactor");
        ...
        add("block.hbm_ntm_rebirth.machine_rtg_grey", "RT Generator");
        add("container.rtg", "RT Generator");
        ...
        add("block.hbm_ntm_rebirth.machine_steam_engine.desc", "Efficiency: 85%%");
        ...
        add("block.hbm_ntm_rebirth.glass_polarized", "Polarized Glass");
        ...
        add("block.hbm_ntm_rebirth.reinforced_glass", "Reinforced Glass");
        add("block.hbm_ntm_rebirth.reinforced_glass_pane", "Reinforced Glass Pane");
        ...
        add("block.hbm_ntm_rebirth.corium_block", "Corium");
        ...
        add("block.hbm_ntm_rebirth.burning_earth", "Burning Grass");
        add("block.hbm_ntm_rebirth.impact_dirt", "Scorched Dirt");
        ...
        add("item.hbm_ntm_rebirth.burnt_bark.desc", "A piece of bark from an exploded golden oak tree.");
        ...
        add("block.hbm_ntm_rebirth.ore_basalt_sulfur", "Sulfur-Rich Basalt");
        add("block.hbm_ntm_rebirth.ore_basalt_fluorite", "Fluorite-Rich Basalt");
        ...
        add("block.hbm_ntm_rebirth.glyphid_base", "Glyphid Hive Block");
        ...
        add("block.hbm_ntm_rebirth.emp_bomb", "EMP Device");
        ...
        add("item.hbm_ntm_rebirth.ams_lens", "Stabilizer Lens");
        ...
        add("item.hbm_ntm_rebirth.grenade_shell_frag", "Compact Grenade Shell");
        add("item.hbm_ntm_rebirth.grenade_shell_stick", "Stick Grenade Shell");
        add("item.hbm_ntm_rebirth.grenade_shell_tech", "High-Tech Grenade Shell");
        add("item.hbm_ntm_rebirth.grenade_shell_nuke", "Nuclear Grenade Shell");
        add("item.hbm_ntm_rebirth.grenade_fuze_s3", "Timed Grenade Fuze, 3s");
        add("item.hbm_ntm_rebirth.grenade_fuze_s7", "Timed Grenade Fuze, 7s");
        add("item.hbm_ntm_rebirth.grenade_fuze_s15", "Timed Grenade Fuze, 15s");
        add("item.hbm_ntm_rebirth.grenade_fuze_impact", "Impact Grenade Fuze");
        add("item.hbm_ntm_rebirth.grenade_fuze_airburst", "Airburst Grenade Fuze");
        add("item.hbm_ntm_rebirth.grenade_filling_powder", "Gunpowder Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_he", "High-Explosive Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_demo", "Demolition Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_inc", "Incendiary Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_wp", "White Phosphorus Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_cluster", "Cluster Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_emp", "EMP Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_plasma", "Plasma Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_laser", "Laser Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_cluster_heavy", "Heavy Cluster Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_nuclear", "Nuclear Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_nuclear_demo", "Nuclear Demolition Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_filling_schrab", "Schrabidium Grenade Charge");
        add("item.hbm_ntm_rebirth.grenade_extra_glue", "Grenade Extra - Glue");
        add("item.hbm_ntm_rebirth.grenade_extra_proxy_fuze", "Grenade Extra - Proximity Fuze");
        add("item.hbm_ntm_rebirth.grenade_extra_frag_sleeve", "Grenade Extra - Fragmentation Sleeve");
        add("item.hbm_ntm_rebirth.grenade_extra_triplex", "Grenade Extra - Triplex");
        add("item.hbm_ntm_rebirth.grenade_universal", "Grenade");
        ...
        add("item.hbm_ntm_rebirth.cbt_device", "CBT Device");
        ...
        add("block.hbm_ntm_rebirth.barbed_wire", "Barbed Wire");
        add("block.hbm_ntm_rebirth.barbed_wire_acid", "Caustic Barbed Wire");
        add("block.hbm_ntm_rebirth.barbed_wire_fire", "Flaming Barbed Wire");
        add("block.hbm_ntm_rebirth.barbed_wire_poison", "Poisoned Barbed Wire");
        add("block.hbm_ntm_rebirth.barbed_wire_ultradeath", "Radioactive Barbed Wire");
        add("block.hbm_ntm_rebirth.barbed_wire_wither", "Withered Barbed Wire");
        add("block.hbm_ntm_rebirth.spikes", "Spikes");
        add("block.hbm_ntm_rebirth.pedestal", "Pedestal");
        add("item.hbm_ntm_rebirth.pedestal_steel", "Steel Pedestal");
        add("item.hbm_ntm_rebirth.bolt_spike", "Railroad Spike");
        add("item.hbm_ntm_rebirth.bolt_spike.desc", "Radiates a threatening aura, somehow");
        add("item.hbm_ntm_rebirth.blades_desh", "Desh Shredder Blades");
        add("item.hbm_ntm_rebirth.blades_steel", "Steel Shredder Blades");
        add("item.hbm_ntm_rebirth.blades_titanium", "Titanium Shredder Blades");
        ...
        add("item.hbm_ntm_rebirth.crystal_cinnebar", "Cinnabar Crystals");
        add("item.hbm_ntm_rebirth.crystal_osmiridium", "Osmiridium Crystals");
        add("item.hbm_ntm_rebirth.crystal_xen", "Artificial Xen Crystal");
        add("item.hbm_ntm_rebirth.crystal_rare", "Rare Earth Crystals");
        add("item.hbm_ntm_rebirth.laser_crystal_co2", "CO2-Desh Laser Crystal");
        add("item.hbm_ntm_rebirth.laser_crystal_bismuth", "BiSmUTh Laser Crystal");
        add("item.hbm_ntm_rebirth.laser_crystal_cmb", "CMB-Schrabidate Antimatter Laser Crystal");
        add("item.hbm_ntm_rebirth.laser_crystal_dnt", "Spark Laser Crystal");
        add("item.hbm_ntm_rebirth.laser_crystal_digamma", "Digamma Laser Crystal");
        add("wavelengths.name.ir", "Infrared");
        add("wavelengths.name.visible", "Visible Light");
        add("wavelengths.name.uv", "Ultraviolet");
        add("wavelengths.name.gamma", "Gamma");
        add("wavelengths.name.drx", "Digamma");
        ...
        add("item.hbm_ntm_rebirth.stopsign", "Stop Sign Battle Axe");
        add("item.hbm_ntm_rebirth.sopsign", "Sop Sign Battle Axe");
        add("item.hbm_ntm_rebirth.chernobylsign", "Chernobyl Warning Sign Battle Axe");
        ...
        add("item.hbm_ntm_rebirth.thruster_large", "Large Thruster");
        ...
        add("item.hbm_ntm_rebirth.powder_bromine", "Bromine Powder");
        ...
        add("block.hbm_ntm_rebirth.pa_beamline.desc", "Optional part, connects different accelerator parts.$Also allows to cheaply extend the ring's size,$for meeting dipole coil size requirements.");
        add("block.hbm_ntm_rebirth.pa_detector.desc", "Requires cooling!$Accepts particles and performs the recipe.$Recipes may require containers (particle capsules).$Particle needs a defocus of 0 to be accepted.");
        add("block.hbm_ntm_rebirth.pa_dipole.desc", "Requires cooling!$Redirects particles based on momentum.$Has outputs for below threshold,$above threshold and above threshold$with redstone applied.$Requires large coils to work.");
        add("block.hbm_ntm_rebirth.pa_quadrupole.desc", "Requires cooling!$Reduces particle defocus by 100 points.$Requires large coils to work.");
        add("block.hbm_ntm_rebirth.pa_rfc.desc", "Requires cooling!$Accelerates particles by 100 points,$and adds 100 points of defocus.$The particle will crash when reaching points of 1000 defocus.");
        add("block.hbm_ntm_rebirth.pa_source.desc", "Requires cooling!$Uses two items to create a particle.");
        ...
        add("item.hbm_ntm_rebirth.blowtorch", "Blowtorch");
        add("item.hbm_ntm_rebirth.acetylene_torch", "Acetylene Welding Torch");
        add("item.hbm_ntm_rebirth.boltgun", "Pneumatic Rivet Gun");
        ...
        add("item.hbm_ntm_rebirth.powder_neodymium", "Neodymium Powder");
        ...
        add("item.hbm_ntm_rebirth.powder_cerium", "Cerium Powder");
        add("item.hbm_ntm_rebirth.powder_cerium_tiny", "Tiny Pile of Cerium Powder");
        add("item.hbm_ntm_rebirth.ingot_lanthanium", "Semi-Stable Lanthanium Ingot");
        add("item.hbm_ntm_rebirth.ingot_lanthanium.desc", "'Lanthanum'");
        add("item.hbm_ntm_rebirth.ingot_lanthanium.desc.P11", "Actually Lanthanum, but whatever.");
        add("item.hbm_ntm_rebirth.powder_lanthanium", "Lanthanium Powder");
        ...
        add("item.hbm_ntm_rebirth.mold_base", "Blank Foundry Mold");
        add("item.hbm_ntm_rebirth.crystal_starmetal", "Starmetal Crystals");
        add("item.hbm_ntm_rebirth.gem_volcanic", "Volcanic Gem");
        add("item.hbm_ntm_rebirth.fragment_iron", "Iron Bedrock Ore Fragment");
        ...
        add("block.hbm_ntm_rebirth.concrete_super", "Über Concrete");
        add("block.hbm_ntm_rebirth.meteor_polished", "Polished Meteor Block");
        add("block.hbm_ntm_rebirth.meteor_brick", "Meteor Bricks");
        add("block.hbm_ntm_rebirth.meteor_brick_mossy", "Mossy Meteor Bricks");
        add("block.hbm_ntm_rebirth.meteor_brick_cracked", "Cracked Meteor Bricks");
        add("block.hbm_ntm_rebirth.meteor_pillar", "Meteor Pillar");
        add("block.hbm_ntm_rebirth.meteor_battery", "Starmetal Static Electricity Generator");
        ...
        add("item.hbm_ntm_rebirth.ball_fireclay", "Fireclay");
        ...
        add("item.hbm_ntm_rebirth.powder_ra226", "Radium-226 Powder");
        ...
        add("item.hbm_ntm_rebirth.powder_iodine", "Iodine Powder");
        ...
        add("item.hbm_ntm_rebirth.powder_molysite", "Molysite");
        ...
        add("item.hbm_ntm_rebirth.powder_impure_osmiridium", "Impure Osmiridium Powder");
        add("item.hbm_ntm_rebirth.powder_strontium", "Strontium Powder");
        add("item.hbm_ntm_rebirth.powder_zirconium", "Zirconium Powder");
        ...
        add("item.hbm_ntm_rebirth.stick_dynamite_fishing", "Stick of Fishing Dynamite");
        ...
        add("item.hbm_ntm_rebirth.circuit_star_piece_bridge_north", "SC - North Bridge");
        add("item.hbm_ntm_rebirth.circuit_star_piece_bridge_south", "SC - South Bridge");
        add("item.hbm_ntm_rebirth.circuit_star_piece_bridge_io", "SC - IO Chip");
        add("item.hbm_ntm_rebirth.circuit_star_piece_bridge_bus", "SC - BUS");
        add("item.hbm_ntm_rebirth.circuit_star_piece_bridge_chipset", "SC - Chipset");
        add("item.hbm_ntm_rebirth.circuit_star_piece_bridge_cmos", "SC - CMOS RAM");
        add("item.hbm_ntm_rebirth.circuit_star_piece_bridge_bios", "SC- BIOS Chip");
        add("item.hbm_ntm_rebirth.circuit_star_piece_cpu_register", "SC - CPU Register");
        add("item.hbm_ntm_rebirth.circuit_star_piece_cpu_clock", "SC - CPU Clock");
        add("item.hbm_ntm_rebirth.circuit_star_piece_cpu_logic", "SC - Arithmetic Logic Unit");
        add("item.hbm_ntm_rebirth.circuit_star_piece_cpu_cache", "SC - CPU Cache");
        add("item.hbm_ntm_rebirth.circuit_star_piece_cpu_ext", "SC - Arsenic Semi Conductor Extension");
        add("item.hbm_ntm_rebirth.circuit_star_piece_cpu_socket", "SC - CPU Socket");
        add("item.hbm_ntm_rebirth.circuit_star_piece_mem_socket", "SC - Memory Socket");
        add("item.hbm_ntm_rebirth.circuit_star_piece_mem_16k_a", "SC - 16k Memory Stick Slot A");
        add("item.hbm_ntm_rebirth.circuit_star_piece_mem_16k_b", "SC - 16k Memory Stick Slot B");
        add("item.hbm_ntm_rebirth.circuit_star_piece_mem_16k_c", "SC - 16k Memory Stick Slot C");
        add("item.hbm_ntm_rebirth.circuit_star_piece_mem_16k_d", "SC - 16k Memory Stick Slot D");
        add("item.hbm_ntm_rebirth.circuit_star_piece_card_board", "SC - Extension Card Board");
        add("item.hbm_ntm_rebirth.circuit_star_piece_card_processor", "SC - Extension Card Processor");
        add("item.hbm_ntm_rebirth.circuit_star_component_chipset", "StarControl Chipset");
        add("item.hbm_ntm_rebirth.circuit_star_component_cpu", "StarControl CPU");
        add("item.hbm_ntm_rebirth.circuit_star_component_ram", "StarControl RAM");
        add("item.hbm_ntm_rebirth.circuit_star_component_card", "StarControl Extension Card");
        add("item.hbm_ntm_rebirth.circuit_star", "StarControl Circuit Board");
        add("item.hbm_ntm_rebirth.circuit_star.desc", "Currently unused, for it lacks an operating system.");
        add("item.hbm_ntm_rebirth.ingot_metal_ingot", "Metal Ingot");
        add("item.hbm_ntm_rebirth.ingot_metal_counter", "Counter");
        add("item.hbm_ntm_rebirth.ingot_metal_key", "Metal Key");
        add("item.hbm_ntm_rebirth.ingot_metal_beacon", "Radio Homing Beacon");
        add("item.hbm_ntm_rebirth.ingot_metal_casing", "Metal Casing");
        add("item.hbm_ntm_rebirth.ingot_metal_clockwork", "Clockwork");
        add("item.hbm_ntm_rebirth.ingot_metal_bar", "Metal Bar");
        add("item.hbm_ntm_rebirth.ingot_metal_detector", "Detector");
        add("item.hbm_ntm_rebirth.chemical_dye_black", "Chemical Dye (Black)");
        add("item.hbm_ntm_rebirth.chemical_dye_red", "Chemical Dye (Red)");
        add("item.hbm_ntm_rebirth.chemical_dye_green", "Chemical Dye (Green)");
        add("item.hbm_ntm_rebirth.chemical_dye_brown", "Chemical Dye (Brown)");
        add("item.hbm_ntm_rebirth.chemical_dye_blue", "Chemical Dye (Blue)");
        add("item.hbm_ntm_rebirth.chemical_dye_purple", "Chemical Dye (Purple)");
        add("item.hbm_ntm_rebirth.chemical_dye_cyan", "Chemical Dye (Cyan)");
        add("item.hbm_ntm_rebirth.chemical_dye_silver", "Chemical Dye (Light Gray)");
        add("item.hbm_ntm_rebirth.chemical_dye_gray", "Chemical Dye (Gray)");
        add("item.hbm_ntm_rebirth.chemical_dye_pink", "Chemical Dye (Pink)");
        add("item.hbm_ntm_rebirth.chemical_dye_lime", "Chemical Dye (Lime)");
        add("item.hbm_ntm_rebirth.chemical_dye_yellow", "Chemical Dye (Yellow)");
        add("item.hbm_ntm_rebirth.chemical_dye_lightblue", "Chemical Dye (Light Blue)");
        add("item.hbm_ntm_rebirth.chemical_dye_magenta", "Chemical Dye (Magenta)");
        add("item.hbm_ntm_rebirth.chemical_dye_orange", "Chemical Dye (Orange)");
        add("item.hbm_ntm_rebirth.chemical_dye_white", "Chemical Dye (White)");
        add("item.hbm_ntm_rebirth.undefined", "Undefined");
    ...
    private void addEntityTranslations() {
        ...
        add("entity.hbm_ntm_rebirth.entity_tesla_crab", "Tesla Crab");
        add("entity.hbm_ntm_rebirth.entity_taint_crab", "Taint Crab");
        add("entity.hbm_ntm_rebirth.entity_ntm_radiation_blaze", "Meltdown Elemental");
        ...
        add("entity.hbm_ntm_rebirth.entity_spear", "Digamma Spear");
    ...
    private void addLegacyLangCompletions() {
        ...
        add("container.missileAssembly", "Missile Assembly Station");
        ...
        add("block.hbm_ntm_rebirth.acid_block", "Acid");
        add("fluid.hbm_ntm_rebirth.mud_fluid", "Poisonous Mud");
        add("block.hbm_ntm_rebirth.toxic_block", "Stereotypical Green Ooze");
        add("block.hbm_ntm_rebirth.schrabidic_block", "Schrabidic Acid");
        add("block.hbm_ntm_rebirth.sulfuric_acid_block", "Sulfuric Acid");
        add("fluid.hbm_ntm_rebirth.toxic_fluid", "Stereotypical Green Ooze");
        add("fluid.hbm_ntm_rebirth.volcanic_lava_fluid", "Volcanic Lava");
        add("fluid.hbm_ntm_rebirth.rad_lava_fluid", "Volcanic Lava");
        ...
        add("upgrade.gui.fortune", " * §dFortune§r: Stacks to level %s");
        add("upgrade.gui.smelter", " * §6Smelter§r");
        add("upgrade.gui.nullifier", " * §8Scrap Destroyer§r");
        add("upgrade.gui.shredder", " * §7Shredder§r");
    ...
    private void addSatelliteTranslations() {
        ...
        add("item.hbm_ntm_rebirth.oil_detector.bullseye", "Oil deposit directly below!");
        add("item.hbm_ntm_rebirth.oil_detector.detected", "Oil detected nearby.");
        add("item.hbm_ntm_rebirth.oil_detector.noOil", "No oil detected.");
        add("item.hbm_ntm_rebirth.survey_scanner", "Survey Scanner");
        add("item.hbm_ntm_rebirth.ore_density_scanner", "Bedrock Ore Density Scanner");
        add("item.hbm_ntm_rebirth.ore_density_scanner.excellent", "Excellent");
        add("item.hbm_ntm_rebirth.ore_density_scanner.high", "High");
        add("item.hbm_ntm_rebirth.ore_density_scanner.low", "Low");
        add("item.hbm_ntm_rebirth.ore_density_scanner.moderate", "Moderate");
        add("item.hbm_ntm_rebirth.ore_density_scanner.poor", "Poor");
        add("item.hbm_ntm_rebirth.ore_density_scanner.veryhigh", "Very High");
        add("item.hbm_ntm_rebirth.ore_density_scanner.verypoor", "Very Poor");
    ...
    private void addArmorModTranslations() {
        ...
        add("item.hbm_ntm_rebirth.upgrade_health", "Emitter Health Upgrade");
        add("item.hbm_ntm_rebirth.upgrade_radius", "Emitter Radius Upgrade");
        ...
        add("item.hbm_ntm_rebirth.nugget_australium", "Australium Nugget");
        add("item.hbm_ntm_rebirth.nugget_australium_greater", "Greater Australium Nugget");
        add("item.hbm_ntm_rebirth.nugget_australium_lesser", "Lesser Australium Nugget");
        ...
        add("item.hbm_ntm_rebirth.billet_flashlead.desc", "The lattice decays, causing antimatter-matter$annihilation reactions, causing the release of$pions, decaying into muons, catalyzing fusion of$the nuclei, creating the new element.$Please try to keep up.");
        ...
        add("item.hbm_ntm_rebirth.battery_spark", "Spark Battery");
        add("item.hbm_ntm_rebirth.battery_trixite", "Off-Brand Spark Battery");
        ...
        add("item.hbm_ntm_rebirth.catalyst_clay", "Clay Catalyst");
        ...
        add("item.bomb_part.used_in", "Used in:");
        ...
        add("item.hbm_ntm_rebirth.ingot_biorubber", "Latex Bar");
        ...
        add("item.hbm_ntm_rebirth.ingot_borax", "Borax Ingot");
        ...
        add("item.hbm_ntm_rebirth.ingot_neodymium", "Neodymium Ingot");
        ...
        add("item.hbm_ntm_rebirth.ingot_redstone", "Redstone Ingot");
        ...
        add("item.hbm_ntm_rebirth.ingot_slag", "Slag Ingot");
        ...
        add("item.hbm_ntm_rebirth.ingot_sodium", "Sodium Ingot");
        add("item.hbm_ntm_rebirth.ingot_sr90", "Strontium-90 Ingot");
        add("item.hbm_ntm_rebirth.ingot_strontium", "Strontium Ingot");
        ...
        add("item.hbm_ntm_rebirth.nugget_arsenic", "Arsenic Nugget");
        ...
        add("item.hbm_ntm_rebirth.pellet_rtg.desc", "RTG fuel pellet for infinite energy! (almost)");
        add("item.hbm_ntm_rebirth.pellet_rtg_actinium", "Actinium-227 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_actinium.desc", "A glow of blue light and beta rays.");
        add("item.hbm_ntm_rebirth.pellet_rtg_americium", "Americium-241 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_americium.desc", "Rare and reliable, good old Americium!");
        add("item.hbm_ntm_rebirth.pellet_rtg_cobalt", "Cobalt-60 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_cobalt.desc", "Not the best as an RTG, but great for gamma radiation!");
        add("item.hbm_ntm_rebirth.pellet_rtg_gold", "Gold-198 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_gold.desc", "Made from a rare, highly unstable gold isotope.");
        add("item.hbm_ntm_rebirth.pellet_rtg_lead", "Lead-209 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_lead.desc", "Exposure will result in immediate death.");
        add("item.hbm_ntm_rebirth.pellet_rtg_polonium", "Polonium-210 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_polonium.desc", "More powerful RTG pellet, made from finest polonium!");
        add("item.hbm_ntm_rebirth.pellet_rtg_radium", "Radium-226 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_radium.desc", "Great starter pellet, sourced from all-natural radium!");
        add("item.hbm_ntm_rebirth.pellet_rtg_strontium", "Strontium-90 RTG Pellet");
        add("item.hbm_ntm_rebirth.pellet_rtg_strontium.desc", "Known to the State of California...");
        ...
        add("item.hbm_ntm_rebirth.plate_welded_aluminium", "Welded Aluminium Plate");
        add("item.hbm_ntm_rebirth.plate_welded_cdalloy", "Welded Cadmium Steel Plate");
        add("item.hbm_ntm_rebirth.plate_welded_combine_steel", "Welded Combine Steel Plate");
        add("item.hbm_ntm_rebirth.plate_welded_copper", "Welded Copper Plate");
        add("item.hbm_ntm_rebirth.plate_welded_iron", "Welded Iron Plate");
        ...
        add("item.hbm_ntm_rebirth.plate_welded_titanium", "Welded Titanium Plate");
        add("item.hbm_ntm_rebirth.plate_welded_tungsten", "Welded Tungsten Plate");
        add("item.hbm_ntm_rebirth.plate_welded_zirconium", "Welded Zirconium Plate");
        add("item.hbm_ntm_rebirth.plate_welded_osmiridium", "Welded Osmiridium Plate");
        ...
        add("foundry.filter", "Filter: %s");
        add("foundry.inverted", "Redstone inverted");
        add("foundry.invertFilter", "Filter inverted");
        add("foundry.noCast", "No mold installed!");
        add("shape.nugget", "Nugget");
        add("shape.billet", "Billet");
        add("shape.ingot", "Ingot");
        add("shape.plate", "Plate");
        add("shape.wireFine", "Wires");
        add("shape.plateTriple", "Cast Plate");
        add("shape.wireDense", "Dense Wire");
        add("shape.shell", "Shell");
        add("shape.ntmpipe", "Pipe");
        add("shape.block", "Block");
        add("shape.barrelLight", "Light Barrel");
        add("shape.barrelHeavy", "Heavy Barrel");
        add("shape.receiverLight", "Light Receiver");
        add("shape.receiverHeavy", "Heavy Receiver");
        add("shape.gunMechanism", "Mechanism");
        add("shape.stock", "Stock");
        add("shape.grip", "Grip");
        add("shape.blade", "Blade");
        add("shape.blades", "Shredder Blades");
        add("shape.stamp", "Press Stamp");
        add("shape.c9", "Small Caliber Casing");
        add("shape.c50", "Large Caliber Casing");
        ...
        add("item.hbm_ntm_rebirth.wire_fine_carbon", "Carbon Wire");
        ...
        add("item.hbm_ntm_rebirth.wire_fine_magnetized_tungsten", "Fine Magnetized Tungsten Wire");
        add("item.hbm_ntm_rebirth.wire_fine_lead", "Fine Lead Wire");
        add("item.hbm_ntm_rebirth.wire_fine_zirconium", "Fine Zirconium Wire");
        add("item.hbm_ntm_rebirth.wire_fine_steel", "Steel Wire");
        ...
        add("hbmmat.uranium", "Uranium");
        add("hbmmat.uranium238", "Uranium-238");
        add("hbmmat.thorium232", "Thorium-232");
        add("hbmmat.plutonium", "Plutonium");
        ...
        add(ModBlocks.DUCRETE_SMOOTH_STAIRS.get(), "Ducrete Stairs");
        add(ModBlocks.DUCRETE_STAIRS.get(), "Ducrete Tile Stairs");
        add(ModBlocks.BRICK_CONCRETE_STAIRS.get(), "Concrete Brick Stairs");
        add(ModBlocks.BRICK_CONCRETE_MOSSY_STAIRS.get(), "Mossy Concrete Brick Stairs");
        add(ModBlocks.BRICK_CONCRETE_CRACKED_STAIRS.get(), "Cracked Concrete Brick Stairs");
        add(ModBlocks.BRICK_CONCRETE_BROKEN_STAIRS.get(), "Broken Concrete Brick Stairs");
        add(ModBlocks.BRICK_DUCRETE_STAIRS.get(), "Ducrete Brick Stairs");
        add(ModBlocks.REINFORCED_STONE_STAIRS.get(), "Dense Stone Stairs");
        add(ModBlocks.REINFORCED_BRICK_STAIRS.get(), "Reinforced Stone Stairs");
        add(ModBlocks.BRICK_OBSIDIAN_STAIRS.get(), "Obsidian Brick Stairs");
        add(ModBlocks.BRICK_LIGHT_STAIRS.get(), "Light Bricks Stairs");
        add(ModBlocks.BRICK_COMPOUND_STAIRS.get(), "Compound Mesh Stairs");
        add(ModBlocks.BRICK_ASBESTOS_STAIRS.get(), "Asbestos Brick Stairs");
        add(ModBlocks.BRICK_FIRE_STAIRS.get(), "Firebrick Stairs");
        add(ModBlocks.ASPHALT_STAIRS.get(), "Asphalt Stairs");
        add(ModBlocks.LIGHTSTONE_TILE_STAIRS.get(), "Lightstone Tile Stairs");
        add(ModBlocks.LIGHTSTONE_BRICKS_STAIRS.get(), "Lightstone Brick Stairs");
        add("block.hbm_ntm_rebirth.lightstone.0", "Raw Lightstone");
        add("block.hbm_ntm_rebirth.lightstone.1", "Lightstone Tile");
        add("block.hbm_ntm_rebirth.lightstone.2", "Lightstone Bricks");
        add("block.hbm_ntm_rebirth.lightstone.3", "Lightstone Chiseled Bricks");
        add("block.hbm_ntm_rebirth.lightstone.4", "Chiseled Lightstone");
        add("block.hbm_ntm_rebirth.concrete_slab.0", "Concrete Slab");
        add("block.hbm_ntm_rebirth.concrete_slab.1", "Concrete Tile Slab");
        add("block.hbm_ntm_rebirth.concrete_slab.2", "Asbestos Concrete Slab");
        add("block.hbm_ntm_rebirth.concrete_slab.3", "Ducrete Slab");
        add("block.hbm_ntm_rebirth.concrete_slab.4", "Ducrete Tile Slab");
        add("block.hbm_ntm_rebirth.concrete_slab.5", "Asphalt Slab");
        add("block.hbm_ntm_rebirth.concrete_brick_slab.0", "Concrete Brick Slab");
        add("block.hbm_ntm_rebirth.concrete_brick_slab.1", "Mossy Concrete Brick Slab");
        add("block.hbm_ntm_rebirth.concrete_brick_slab.2", "Cracked Concrete Brick Slab");
        add("block.hbm_ntm_rebirth.concrete_brick_slab.3", "Broken Concrete Brick Slab");
        add("block.hbm_ntm_rebirth.concrete_brick_slab.4", "Ducrete Brick Slab");
        add("block.hbm_ntm_rebirth.brick_slab.0", "Dense Stone Slab");
        add("block.hbm_ntm_rebirth.brick_slab.1", "Reinforced Stone Slab");
        add("block.hbm_ntm_rebirth.brick_slab.2", "Obsidian Brick Slab");
        add("block.hbm_ntm_rebirth.brick_slab.3", "Light Brick Slab");
        add("block.hbm_ntm_rebirth.brick_slab.4", "Compound Mesh Slab");
        add("block.hbm_ntm_rebirth.brick_slab.5", "Asbestos Brick Slab");
        add("block.hbm_ntm_rebirth.brick_slab.6", "Firebrick Slab");
        add("block.hbm_ntm_rebirth.stones_slab.0", "Lightstone Tile Slab");
        add("block.hbm_ntm_rebirth.stones_slab.1", "Lightstone Brick Slab");
