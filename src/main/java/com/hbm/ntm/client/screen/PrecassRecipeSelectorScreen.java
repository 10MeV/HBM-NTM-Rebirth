...
public class PrecassRecipeSelectorScreen extends Screen {
    ...
    private final PrecassScreen previousScreen;
    ...
    protected PrecassRecipeSelectorScreen(PrecassScreen previousScreen) {
        super(Component.translatableWithFallback("container.machinePrecAss", "Precision Assembly Machine"));
        ...
        this.allRecipes = GenericMachineRecipeSelector.recipes(
                ...
                previousScreen.getMenu().getBlockEntity().getItems().getStackInSlot(1));
        regenerateRecipes("");
    }
    ...
    private void sendSelection() {
        ...
        ModMessages.sendTileControl(previousScreen.getMenu().getBlockEntity().getBlockPos(),
                LegacyGenericSelectorMachineBlockEntity.recipeSelectionTag(selection));
    }
}
