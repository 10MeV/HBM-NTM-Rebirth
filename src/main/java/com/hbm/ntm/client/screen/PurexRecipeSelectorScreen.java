...
public class PurexRecipeSelectorScreen extends Screen {
    ...
    protected PurexRecipeSelectorScreen(PurexScreen previousScreen) {
        super(Component.translatableWithFallback("container.machinePUREX", "PUREX"));
