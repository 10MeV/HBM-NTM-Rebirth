...
public class FusionTorusRecipeSelectorScreen extends Screen {
    ...
    private final FusionTorusScreen previousScreen;
    ...
    protected FusionTorusRecipeSelectorScreen(FusionTorusScreen previousScreen) {
        super(Component.translatableWithFallback("container.fusionTorus", "Fusion Reactor Vessel"));
        this.previousScreen = previousScreen;
        FusionTorusBlockEntity blockEntity = previousScreen.getMenu().getBlockEntity();
        ...
        this.allRecipes = GenericMachineRecipeSelector.recipes(blockEntity.getLevel(),
                ...
                blockEntity.getItems().getStackInSlot(FusionTorusBlockEntity.SLOT_BLUEPRINT));
        regenerateRecipes("");
    }
    ...
    private void sendSelection() {
        ...
        ModMessages.sendTileControl(previousScreen.getMenu().getBlockEntity().getBlockPos(),
                FusionTorusBlockEntity.recipeSelectionTag(selection));
    }
}
