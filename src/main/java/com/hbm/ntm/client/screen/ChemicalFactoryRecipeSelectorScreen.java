...
public class ChemicalFactoryRecipeSelectorScreen extends Screen {
    ...
    private final ChemicalFactoryScreen previousScreen;
    ...
    protected ChemicalFactoryRecipeSelectorScreen(ChemicalFactoryScreen previousScreen, int module) {
        super(Component.translatableWithFallback("container.machineChemicalFactory", "Chemical Factory"));
        ...
        this.allRecipes = GenericMachineRecipeSelector.recipes(
                ...
                previousScreen.getMenu().getBlockEntity().getItems()
                        .getStackInSlot(ChemicalFactoryBlockEntity.blueprintSlot(module)));
        regenerateRecipes("");
    }
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        page = delta > 0 ? Math.max(0, page - 1) : Math.min(maxPage(), page + 1);
        return true;
    }
    ...
    private void sendSelection() {
        ...
        ModMessages.sendTileControl(previousScreen.getMenu().getBlockEntity().getBlockPos(),
                ChemicalFactoryBlockEntity.recipeSelectionTag(module, selection));
    }
}
