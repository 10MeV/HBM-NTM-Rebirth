...
/** OBJ renderer for the cargo-tram trailer. */
public final class CargoTramTrailerRenderer extends EntityRenderer<CargoTramTrailerEntity> {
    public CargoTramTrailerRenderer(EntityRendererProvider.Context context) { super(context); shadowRadius = 0.0F; }

    @Override
    public void render(CargoTramTrailerEntity entity, float yaw, float partialTick, PoseStack poseStack,
        ...
        ObjVehicleModels.TRAM_TRAILER.renderAll(ObjVehicleModels.TRAM_TRAILER_TEXTURE, poseStack, buffer, packedLight,
                OverlayTexture.NO_OVERLAY);
        poseStack.popPose();
        super.render(entity, yaw, partialTick, poseStack, buffer, packedLight);
    }

    @Override public ResourceLocation getTextureLocation(CargoTramTrailerEntity entity) { return ObjVehicleModels.TRAM_TRAILER_TEXTURE; }
}
