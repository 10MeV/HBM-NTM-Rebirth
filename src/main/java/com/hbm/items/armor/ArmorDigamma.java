...
/** Legacy package carrier for FAU/Digamma powered FSB armor. */
@Deprecated(forRemoval = false)
public class ArmorDigamma extends FsbPoweredArmorItem {
    public ArmorDigamma(HbmArmorMaterials material, ArmorItem.Type type, Properties properties,
