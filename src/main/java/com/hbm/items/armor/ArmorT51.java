...
/** Legacy package carrier for T51 powered FSB armor. */
@Deprecated(forRemoval = false)
public class ArmorT51 extends FsbPoweredArmorItem {
    public ArmorT51(HbmArmorMaterials material, ArmorItem.Type type, Properties properties,
