...
/** Legacy package carrier for AJRO powered FSB armor. */
@Deprecated(forRemoval = false)
public class ArmorAJRO extends FsbPoweredArmorItem {
    public ArmorAJRO(HbmArmorMaterials material, ArmorItem.Type type, Properties properties,
