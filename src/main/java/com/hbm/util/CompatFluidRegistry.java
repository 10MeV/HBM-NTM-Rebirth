...
/**
 * Legacy package facade for compat fluid and container registration.
 */
...
public final class CompatFluidRegistry {
    ...
    public static FluidType registerFluid(String name, int id, int color, int poison, int flammability,
        ...
        return com.hbm.ntm.compat.CompatFluidRegistry.registerFluid(name, id, color, poison, flammability,
                reactivity, symbol, texture);
    }
    ...
    public static FluidType registerFluid(String name, int id, int color, int poison, int flammability,
        ...
        return com.hbm.ntm.compat.CompatFluidRegistry.registerFluid(name, id, color, poison, flammability,
                reactivity, symbol, texture, forgeFluidId);
    }
    ...
    public static FluidType registerFluid(String name, int id, int color, int poison, int flammability,
        ...
        return com.hbm.ntm.compat.CompatFluidRegistry.registerFluid(name, id, color, poison, flammability,
                reactivity, symbol, texture, forgeFluid);
    }
