...
/**
 * Legacy 1.7.10 package bridge for the Either helper.
 */
...
public final class Either<L, R> {
    ...
    public static <L, R> Either<L, R> fromModern(com.hbm.ntm.util.HbmEither<L, R> either) {
    ...
    public com.hbm.ntm.util.HbmEither<L, R> modern() {
        return left ? com.hbm.ntm.util.HbmEither.left((L) value) : com.hbm.ntm.util.HbmEither.right((R) value);
    }
}
