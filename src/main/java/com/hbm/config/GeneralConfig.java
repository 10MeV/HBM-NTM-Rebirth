...
public final class GeneralConfig {
    ...
    public static boolean enableColtanDepsoit = true;
    public static boolean enableColtanDeposit = true;
    public static boolean enableColtanSpawning = false;
    public static boolean enableBedrockDepsoit = true;
    public static boolean enableBedrockSpawning = false;
    ...
    public static int oreColtanFrequency = 2;
    public static int bedrockColtanFrequency = 50;
