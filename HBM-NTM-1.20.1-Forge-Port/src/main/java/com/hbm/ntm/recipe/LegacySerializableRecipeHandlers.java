...
public final class LegacySerializableRecipeHandlers {
    ...
    private static final List<Handler> HANDLERS = List.of(
            ...
            unsupported("CentrifugeRecipes", "hbmCentrifuge.json", Category.MACHINE,
                    "centrifuge uses a dedicated item/fluid output format"),
            unsupported("CrystallizerRecipes", "hbmCrystallizer.json", Category.MACHINE,
                    "crystallizer uses dedicated fluid-to-item logic and no modern serializer yet"),
            ...
            unsupported("PyroOvenRecipes", "hbmPyrolysis.json", Category.FLUID,
                    "pyrolysis oven uses dedicated oil processing semantics"),
            ...
            unsupported("ArcWelderRecipes", "hbmArcWelder.json", Category.MACHINE,
                    "arc welder uses a dedicated recipe format and no modern serializer yet"),
