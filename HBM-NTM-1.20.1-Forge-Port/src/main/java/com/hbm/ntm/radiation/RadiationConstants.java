...
public final class RadiationConstants {
    public static final float MAX_PLAYER_RADIATION = 2500.0F;
    public static final float MAX_CHUNK_RADIATION = 100_000.0F;
    ...
    public static final float SA_FUEL = 5.85F;
