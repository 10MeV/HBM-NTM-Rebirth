...
public final class ObjNetworkModels {
    ...
    public static final LegacyWavefrontModel CONNECTOR_LEGACY = legacyModel("connector").noSmooth();
    public static final LegacyWavefrontModel CONNECTOR_SUPER_LEGACY = legacyModel("connector_super").noSmooth();
    public static final LegacyWavefrontModel PYLON_LARGE_LEGACY = legacyModel("pylon_large").noSmooth();
    public static final LegacyWavefrontModel PYLON_MEDIUM_LEGACY = legacyModel("pylon_medium").noSmooth();
