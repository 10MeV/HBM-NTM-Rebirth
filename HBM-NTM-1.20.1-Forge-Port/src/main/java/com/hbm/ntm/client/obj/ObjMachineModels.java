...
public final class ObjMachineModels {
    ...
    public static final LegacyWavefrontModel FIREBOX_LEGACY = legacyModel("firebox").noSmooth();
    public static final LegacyWavefrontModel HEATING_OVEN_LEGACY = legacyModel("heating_oven").noSmooth();
    public static final LegacyWavefrontModel ELECTRIC_HEATER_LEGACY = legacyModel("electric_heater").noSmooth();
    public static final LegacyWavefrontModel RTG_LEGACY = legacyModel("rtg").noSmooth();
    public static final LegacyWavefrontModel RADAR_BODY_LEGACY = legacyModel("radar_base").noSmooth();
    public static final LegacyWavefrontModel RADAR_LEGACY = legacyModel("radar", "radar_base").noSmooth();
    public static final LegacyWavefrontModel RADAR_LARGE_LEGACY = legacyModel("radar_large").noSmooth();
    public static final LegacyWavefrontModel RADAR_SCREEN_LEGACY = legacyModel("radar_screen").noSmooth();
    public static final LegacyWavefrontModel SOLAR_MIRROR_LEGACY = legacyModel("solar_mirror").noSmooth();
    public static final LegacyWavefrontModel ARC_WELDER = legacyModel("arc_welder").noSmooth();
    public static final LegacyWavefrontModel SOLDERING_STATION = legacyModel("soldering_station").noSmooth();
    ...
    public static final LegacyWavefrontModel AUTOSAW = legacyModel("autosaw").noSmooth();
